...
namespace MilitaryDistrictAPI.Controllers.scaffolded
{
    public class VehiclesController : Controller
    {
        ...
        public VehiclesController(MilitaryDistrict2Context context)
        {
            _context = context;
        }
        ...
        {
            var military_district_2Context = _context.Vehicles.Include(v => v.VehicleCategory);
        ...
        public async Task<IActionResult> Create([Bind("VehicleId,VehicleCategoryId,Name,Amount")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VehicleId,VehicleCategoryId,Name,Amount")] Vehicle vehicle)
        {
